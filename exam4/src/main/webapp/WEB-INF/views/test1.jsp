...
<head>
	...
	<script src="<%=request.getContextPath()%>/resources/js/test.js" type="text/javascript"></script>
<script>
...
<!--                 <a href="#">LOGIN</a> | -->
                ...
                ID <input type = "text" name = "id" class="login" id="id"> 
                PW <input type = "password" name = "pw" class="login" id="pw">
